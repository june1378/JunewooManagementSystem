...
public class MenuManagement {
	public static void main(String[] args) {
		...
		while (num!=9) {
			...
			System.out.println("2.Add the number of food");
			System.out.println("3.Add the price of food");
			System.out.println("4.Delete the name of food");
			System.out.println("5.Delete the number of food");
			System.out.println("6.Delete the price of food");
			System.out.println("7. Edit");
			System.out.println("8. View the total orders");
